...
class IndexHandler(RequestHandler):
    ...
    def post(self,*args,**kwargs):
        ...
        print(filename)
        if not os.path.exists('/home/tarena/images/{}'.format(username)):
            os.makedirs('/home/tarena/images/{}'.format(username))
        data = avatar.get('body')
        with open('/home/tarena/images/{}/{}'.format(username,filename),'wb') as f:
            f.write(data)
